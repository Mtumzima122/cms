...
if ($role === 'super Admin') {
    $sql = "SELECT suggestions.*, departments.department_name 
            FROM suggestions 
            JOIN departments ON suggestions.department_id = departments.department_id";
} else {
    $sql = "SELECT suggestions.*, departments.department_name 
            FROM suggestions 
            JOIN departments ON suggestions.department_id = departments.department_id 
            WHERE suggestions.department_id = $department_id";
}
